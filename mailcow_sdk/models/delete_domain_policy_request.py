...
class DeleteDomainPolicyRequest(BaseModel):
    """
    DeleteDomainPolicyRequest
    """ # noqa: E501
    items: Optional[Dict[str, Any]] = Field(default=None, description="contains list of domain policys you want to delete")
