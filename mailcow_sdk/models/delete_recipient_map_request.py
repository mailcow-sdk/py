...
class DeleteRecipientMapRequest(BaseModel):
    """
    DeleteRecipientMapRequest
    """ # noqa: E501
    items: Optional[Dict[str, Any]] = Field(default=None, description="contains list of recipient maps you want to delete")
