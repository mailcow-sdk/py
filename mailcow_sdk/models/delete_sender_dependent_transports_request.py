...
class DeleteSenderDependentTransportsRequest(BaseModel):
    """
    DeleteSenderDependentTransportsRequest
    """ # noqa: E501
    items: Optional[Dict[str, Any]] = Field(default=None, description="contains list of Sender-Dependent Transport you want to delete")
