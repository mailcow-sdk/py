...
class UpdateMailboxCustomAttributesRequestAttr(BaseModel):
    """
    UpdateMailboxCustomAttributesRequestAttr
    """ # noqa: E501
    attribute: Optional[Dict[str, Any]] = Field(default=None, description="Array of attribute keys")
    value: Optional[Dict[str, Any]] = Field(default=None, description="Array of attribute values")
