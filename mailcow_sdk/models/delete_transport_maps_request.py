...
class DeleteTransportMapsRequest(BaseModel):
    """
    DeleteTransportMapsRequest
    """ # noqa: E501
    items: Optional[Dict[str, Any]] = Field(default=None, description="contains list of transport maps you want to delete")
